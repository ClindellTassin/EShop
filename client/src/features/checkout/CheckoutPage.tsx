...
export default function CheckoutPage() {
    ...
    const methods = useForm({ mode: 'all', resolver: yupResolver(currentValidationSchema) });
                    ...
                    {activeStep === steps.length ? (
                        ...
                        <form onSubmit={methods.handleSubmit(handleNext)}>
                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                                ...
                                <LoadingButton disabled={submitDisabled()} loading={loading} variant="contained" type='submit' sx={{ mt: 3, ml: 1 }}>
